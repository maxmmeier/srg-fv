  ...
  resources: {
    de: {
      translation: {
        ...
        supportAssociationSrgStuttgartShort: 'Förderverein',
        ...
        boardImageDescription:
          'v. l. n. r. Stipe Brnic (1. Vorsitzender), Markus Schenker-Ludwig (2. Vorsitzender), Ciara Kämpf (Kassiererin), Johanna Granzow-Emden (Schriftführerin), Max Meier (Beisitzer)',
        board: 'Vorstand',
